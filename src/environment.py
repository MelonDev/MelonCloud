...
TWITTER_USER_ID = config('TWITTER_USER_ID', default=None)
...
MELONCLOUD_BOOK_VERIFY_KEY = config('MELONCLOUD_BOOK_VERIFY_KEY', default=None)
MELONCLOUD_BOOK_API_KEY = config('MELONCLOUD_BOOK_API_KEY', default=None)


IFTTT_SECRET_KEY = config('IFTTT_SECRET_KEY', default="")
